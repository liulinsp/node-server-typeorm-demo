/*
 ...
 Source Schema         : server-demo-orm

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 23/03/2020 17:25:05
*/
...
CREATE TABLE `sys_order`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `orderTime` timestamp(0) NOT NULL COMMENT '下单时间',
  `customerId` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_47a4da9386043a72e1acf737143`(`customerId`) USING BTREE,
  CONSTRAINT `FK_47a4da9386043a72e1acf737143` FOREIGN KEY (`customerId`) REFERENCES `sys_customer` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `sys_person`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '姓名',
  `infoId` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `REL_f92d494a816a4e79fb9e359597`(`infoId`) USING BTREE,
  CONSTRAINT `FK_f92d494a816a4e79fb9e359597a` FOREIGN KEY (`infoId`) REFERENCES `sys_info` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
